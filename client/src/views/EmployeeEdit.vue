...
<script>
// import { Api } from '@/Api'        <input type="submit" value="Submit"> <button @click="saveEmployee(employeeObject._id, fname.value, lname.value, userName.value, userPass.value)">saveEmployee</button>
